...
ALTER TABLE post2tag
    ADD CONSTRAINT FK_POST_ON_TAG FOREIGN KEY (tag_id) REFERENCES tags ON DELETE CASCADE;
ALTER TABLE post2tag
    ADD CONSTRAINT FK_TAG_ON_POST FOREIGN KEY (post_id) REFERENCES posts ON DELETE CASCADE;
