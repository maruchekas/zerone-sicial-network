...
import com.skillbox.javapro21.repository.NotifTypeRepository;
...
public class NotificationServiceImpl implements NotificationService {
    private final NotifTypeRepository notifTypeRepository;
    private final NotificationRepository notificationRepository;
    private final UtilsService utilsService;

    /**
     * 1.Полуть Глобальные настройки оповещений пользователя.
