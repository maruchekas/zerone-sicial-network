...
public class ProfileController {
    ...
    public ResponseEntity<DataResponse<Person>> getPerson(Principal principal) {
    ...
    @PutMapping("/me")
    @PreAuthorize("hasAuthority('user:write')")
    public ResponseEntity<DataResponse<Person>> editPerson(Principal principal, @RequestBody EditProfileRequest editProfileRequest) {
